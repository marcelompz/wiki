...
| **Staging (Hetzner)** | `178.105.226.175` | `https://staging.provecchio.com` | `/srv/orderflow-staging` | `.env.staging` | `5433` / `3012` / `3013` |
| **Production (Hetzner)** | `178.105.226.175` | `https://provecchio.com` | `/srv/orderflow` | `.env.production` | `5432` / `3010` / `3011` |
| **Production Provecchio**| `38.52.135.227` | `http://dimora.provecchio.com:8083` | `/srv/orderflow` (en VM `192.168.69.240`) | `.env.prod` | `5432` / `3010` / `3011` |
...
* **Propósito:** Pruebas avanzadas multi-tenant, testing E2E, integraciones con Google OAuth (con scopes de teléfono/cumpleaños) y pruebas de API.
...
* **Propósito:** Producción SaaS global dedicada para múltiples empresas.
...
* **Propósito:** Instancia física dedicada instalada in-house en el servidor local de Provecchio Di Mora para facturación y comanda offline-resiliente.
