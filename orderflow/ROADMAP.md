...
**Última Actualización:** 2026-08-26 (Release v1.20.41 — Estandarización de Inventario Paso 8 Landed Costs & Wizard Onboarding Odoo 1-Click)

**Versión Actual:** **`v1.20.41`** 🔄 **PRODUCTION READY** | Marca pública: OmniFlow. Capa técnica interna: OrderFlow.
**Próximo Release:** **v1.21.0 (En progreso — Marketplace de Plugins & Facturación Stripe/Mercado Pago)**
**Estado:** ✅ **STAGING & PRODUCTION OPERATIVE** | 🏆 **COMMERCIAL RELEASE v1.20.41 STABLE** | QA E2E Suite Integrada | 670+ tests unitarios pasados
