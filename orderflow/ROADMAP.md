...
**Última Actualización:** 2026-08-13 ART (Release v1.20.4 — OmniFlow Decoupled Architecture & Multi-Tier Optimization)

**Versión Actual:** **`v1.20.7`** ✅ **RELEASED (Stable)** | Marca pública: OmniFlow. Capa técnica interna: OrderFlow.
**Próximo Release:** **v1.21.0 (Planning)**
