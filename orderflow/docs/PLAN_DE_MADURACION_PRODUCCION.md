...
- **Frontend (`Dockerfile.prod`):** Creado usando Alpine, sirve build estático con `serve` y configuración SPA estricta (`frontend/serve.json`). El enrutamiento y SSL lo maneja Traefik v3.3.
