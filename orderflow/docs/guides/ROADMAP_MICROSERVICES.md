...
| **9. OmniCapitalHumano & OmniAsistencia Standalone** | `services/hr-standalone` | `:3028` | `rrhh.pesallaccia.com` | ✅ **LISTO (v1.0.0)** | Suite de Legajo Digital (`Employee`), Nómina parametrizable `l10n-py`, Ausencias, Vacaciones (12/18/30d), Marcador de Asistencia (NFC/QR/Geocercas GPS Haversine) y Webhooks Hardware (ZKTeco/Hikvision). |
