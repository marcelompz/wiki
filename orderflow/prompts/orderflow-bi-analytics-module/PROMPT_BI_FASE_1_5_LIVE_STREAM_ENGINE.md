...
**Dependencias:** Fase 0 (Data Foundation) — dura. Fase 1 (Backend Core) no es requisito técnico (Live Engine no consulta el Strategic Engine ni sus endpoints); puede ejecutarse en paralelo con Fase 1 si hay capacidad de equipo.  
...
9. Mecanismo de idempotencia documentado para evitar doble conteo ante reintentos de BullMQ.
